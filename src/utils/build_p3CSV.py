...
print("⚙️ Building Phase 3 Tracker...")

# Get the project root directory
project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

# 1. Load the Phase 2 Audit Trail
audit_file = os.path.join(project_root, "data", "audit", "Audit_Trail_src.csv")
...
phase3_df = df_included[['Title', 'Author', 'Publication Title']].copy()
...
cols = ['Title', 'Author', 'Publication Title', 'Publication Year', 'Primary_Reviewer'] + blank_cols
